...
class Model{
  ...
  static public function select_all(){
	  ...
	  $rows =  self::wpdb()->get_results(sprintf("SELECT * FROM `%s`", static::getTableName()), ARRAY_A);
  ...
  static public function getTableName(){
      ...
      if(is_multisite()){
        $table_name = \NRDQ_XMLFeed\db::wpdb()->get_blog_prefix();
      } else {
        $table_name = \NRDQ_XMLFeed\db::wpdb()->prefix;
      }
