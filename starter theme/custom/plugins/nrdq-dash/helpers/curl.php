...
class Curl
{
    ...
    public function setPatch($postFields)
    {
        $this->_patch = true;
        $this->_postFields = $postFields;
    }
    ...
    {
        $this->_includeHTTPHeader = $header;
    }
    ...
    public function createCurl($url = 'null')
    {
        ...
        if ($this->_includeHTTPHeader) {
            curl_setopt($s, CURLOPT_HTTPHEADER, $this->_includeHTTPHeader);
        } else {
