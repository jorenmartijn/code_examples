...
class NRDQ_LimitUploadSize_Controller {
  ...
  private function enqueue_custom_files(){
	  if(NRDQ_LIMITUPLOADSIZE_ADMIN_CSS_REQUIRED) add_action( 'admin_enqueue_scripts', array($this, 'add_admin_styles') );	 
		if(NRDQ_LIMITUPLOADSIZE_ADMIN_JS_REQUIRED) add_action( 'admin_enqueue_scripts', array($this, 'add_admin_scripts'));
		if(NRDQ_LIMITUPLOADSIZE_CSS_REQUIRED) add_action( 'wp_enqueue_scripts', array($this, 'add_frontend_styles') );	 
	  if(NRDQ_LIMITUPLOADSIZE_JS_REQUIRED) add_action( 'wp_enqueue_scripts', array($this, 'add_frontend_scripts') );
  }
