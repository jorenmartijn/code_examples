...
function NRDQ_add_gutenberg_assets() {
    if( file_exists( get_template_directory() . '/../../build_ikwil/css/gutenberg-style.min.css' ) ) {
        wp_enqueue_style( 'NRDQ-gutenberg', WP_CONTENT_URL . '/build_ikwil/css/gutenberg-style.min.css' );
    }
}
