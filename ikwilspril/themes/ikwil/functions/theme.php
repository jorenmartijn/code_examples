...
function add_image_sizes() {
    // Image examples
    /* Image
        <img class="lazy" data-src="<?= content_url(); ?>/build_ikwil/img/nothing.gif" alt="<?=esc_attr($alt);?>" data-lazy="
      ...
      Background Image
      <div class="image-container bg-lazy" data-src="<?= content_url(); ?>/build_ikwil/img/nothing.gif" data-lazy="
