...
function nrdq_get_image_url($id, $size = 'thumbnail', $fallback = ''){
    ...
    if(!$id){
        ...
        if(file_exists(home_url('/custom/build_ikwil/img/default.png'))){
            return home_url('/custom/build_ikwil/img/default.png');
        } elseif(file_exists(home_url('/custom/build_ikwil/img/default.jpg'))){
            return home_url('/custom/build_ikwil/img/default.jpg');
        }
    }
